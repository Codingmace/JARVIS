...
if __name__ == "__main__":
    categoriesUrl = 'https://wallpapercave.com/categories/'
...
#    categorySelection = input("Select a category : ")
    ...
    # <li id="latestm"><a href="/latest-uploads">Latest</a></li> 
    #
    # <a href="/american-horror-story-wallpapers" class="albumthumbnail" title="87 wallpapers in American Horror Story Wallpapers">
    # <script>
